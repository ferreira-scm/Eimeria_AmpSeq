...
##Standard curves
data.std<- read.csv("data/Lab/Eimeria_quantification_Std_Curve_data.csv")
data.std%>%
...
data.unk<-read.csv("data/Lab/Eimeria_quantification_Sample_data.csv")
...
data.inf.exp<-read.csv("data/Lab/Eimeria_quantification_Inf_exp_data.csv")
data.inf.exp%>%
